...
public class AudioPlayer 
{
   ...
   public static final int LOOP_CONTINUOUSLY = -1;
	...
	public void playbg()
	{
		...
		clip.setFramePosition(70000);    //  frame where clips starts 
		
		// System.out.println(clip.getFrameLength());
		
		// start playing
		clip.loop(LOOP_CONTINUOUSLY);
		clip.setLoopPoints(70000, clip.getFrameLength() - 10000);   //  frames where clips start playing and when stops
