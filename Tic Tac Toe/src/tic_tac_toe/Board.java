				...
				if (me.getButton() == 1) {
					for (Square sqr : squares) {
						if (me.getX() >= sqr.getX() && me.getX() <= sqr.getX() + sqr.getWidth()
								&& me.getY() >= sqr.getY() && me.getY() <= sqr.getY() + sqr.getHeight()
								&& sqr.getFigure() == null) {
							if (player1) {
					...
					if ((squares.get(0).getFigure() == "circle" && squares.get(1).getFigure() == "circle"
							...
							|| (squares.get(1).getFigure() == "circle" && squares.get(4).getFigure() == "circle"
									&& squares.get(7).getFigure() == "circle")
							|| (squares.get(2).getFigure() == "circle" && squares.get(5).getFigure() == "circle"
									&& squares.get(8).getFigure() == "circle")
						...
						if (bluePlayerWin == false)
							...
							|| (squares.get(0).getFigure() == "x" && squares.get(3).getFigure() == "x"
									&& squares.get(6).getFigure() == "x")
							|| (squares.get(1).getFigure() == "x" && squares.get(4).getFigure() == "x"
									&& squares.get(7).getFigure() == "x")
							|| (squares.get(2).getFigure() == "x" && squares.get(5).getFigure() == "x"
									&& squares.get(8).getFigure() == "x")
